/**
 * Cloudflare R2 storage utilities for Assistant document management.
 ...
 *   R2_BUCKET_NAME      — bucket name (default: "ll-wrkengine")
 */
...
const BUCKET = process.env.R2_BUCKET_NAME ?? "ll-wrkengine";
