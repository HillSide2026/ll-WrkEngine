...
export default function ProjectAssistantChatPage({ params }: Props) {
    ...
    const handleDocClick = (doc: AssistantDocument) => {
        openTab(doc.id, doc.filename);
    };

    const handleCitationClick = (citation: AssistantCitationAnnotation) => {
        openTab(
    ...
    const handleEditViewClick = (ann: AssistantEditAnnotation, filename: string) => {
                            ...
                            onDragOver={(e) => {
                                ...
                                const isInternal =
                                    Array.from(e.dataTransfer.types).includes(
                                        "application/assistant-doc",
                                    ) ||
                                    Array.from(e.dataTransfer.types).includes(
                                        "application/assistant-folder",
                                    );
