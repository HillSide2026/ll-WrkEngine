...
import type { AssistantDocument, AssistantFolder } from "@/app/components/shared/types";
...
interface Props {
    ...
    onDocClick: (doc: AssistantDocument) => void;
...
export function ProjectExplorer({
    ...
    async function handleDropOnTarget(targetFolderId: string | null, e: React.DragEvent) {
        const docId = e.dataTransfer.getData("application/assistant-doc");
        const movingFolderId = e.dataTransfer.getData("application/assistant-folder");
    ...
    function isInternalDrag(e: React.DragEvent): boolean {
        return (
            Array.from(e.dataTransfer.types).includes("application/assistant-doc") ||
            Array.from(e.dataTransfer.types).includes("application/assistant-folder")
        );
    }
