...
import type { AssistantDocument, AssistantProject, AssistantWorkflow } from "../shared/types";
import {
    getProject,
    listProjects,
...
export function AddNewTRModal({
    ...
    const [projectDocs, setProjectDocs] = useState<AssistantDocument[]>([]);
    const [loadingDocs, setLoadingDocs] = useState(false);

    // Full directory (when underProject is false)
    const [standaloneDocs, setStandaloneDocs] = useState<AssistantDocument[]>([]);
    const [directoryProjects, setDirectoryProjects] = useState<AssistantProject[]>(
        [],
    );
    ...
    const directoryFolders = isProjectMode
        ...
        : underProject
          ? []
          : directoryProjects;
    const flatProjectDocs: AssistantDocument[] =
