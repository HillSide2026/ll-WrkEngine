...
import { createWorkflow, updateWorkflow } from "@/app/lib/api";
...
interface Props {
    open: boolean;
    onClose: () => void;
    onCreated: (workflow: AssistantWorkflow) => void;
    editWorkflow?: AssistantWorkflow;
    onUpdated?: (workflow: AssistantWorkflow) => void;
}
