...
import type { AssistantWorkflow } from "../shared/types";
...
export function WorkflowList() {
    ...
    const { user } = useAuth();
    const [custom, setCustom] = useState<AssistantWorkflow[]>([]);
    const [loading, setLoading] = useState(true);
    const [selected, setSelected] = useState<AssistantWorkflow | null>(null);
    ...
    const [typeFilter, setTypeFilter] = useState<AssistantWorkflow["type"] | null>(
        null,
    );
    ...
    const getTypeMeta = (type: AssistantWorkflow["type"]) =>
        type === "tabular"
