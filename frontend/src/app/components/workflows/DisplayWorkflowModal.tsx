...
import type { AssistantDocument, AssistantWorkflow } from "../shared/types";
import { createTabularReview } from "@/app/lib/api";
import { useRouter } from "next/navigation";
import { formatIcon, formatLabel } from "../tabular/columnFormat";
import { useDirectoryData } from "../shared/useDirectoryData";
import { FileDirectory } from "../shared/FileDirectory";
import type { AssistantProject } from "../shared/types";
...
// ---------------------------------------------------------------------------
function AssistantPanel({ workflow }: { workflow: AssistantWorkflow }) {
    return (
...
// ---------------------------------------------------------------------------
function TabularPanel({ workflow }: { workflow: AssistantWorkflow }) {
...
export function DisplayWorkflowModal({ workflows, workflow, onClose }: Props) {
    ...
    const [selected, setSelected] = useState<AssistantWorkflow | null>(workflow);
    ...
    async function handleStartChat() {
        ...
        try {
            ...
            if (!chatId) return;
            const allDocs: AssistantDocument[] = [
                ...standaloneDocuments,
