...
import type { AssistantChat, AssistantMessage } from "@/app/components/shared/types";
...
interface ChatHistoryContextType {
    ...
    newChatMessages: AssistantMessage[] | null;
    setNewChatMessages: (messages: AssistantMessage[] | null) => void;
    replaceChatId: (
        oldChatId: string,
        newChatId: string,
        title?: string,
